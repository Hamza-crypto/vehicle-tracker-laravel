        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('bins.update' ,$bin->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input
                                class="form-control form-control-lg mb-3 @error('number') is-invalid @enderror "
                                type="number"
                                name="number"
                                placeholder="Enter 6 digit BIN "
                                value="{{ old('number', $bin->number) }}"
                            />
                            @error('number')
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('min_amount',$bin->min_amount )}}"
                                    />
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('max_amount',$bin->max_amount)}}"
                                    />
                        ...
                        <div class="form-group">
                            ...
                            <select name="gateway_id" id="gateway"
                                ...
                                @foreach($gateways as $gateway)
                                    <option
                                        value="{{ $gateway->id }}" {{ $gateway->id == $bin->gateway_id ? 'selected' : '' }}>{{ $gateway->title }}
                                    </option>
                                @endforeach
                            </select>
                            @error('role')
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-lg btn-primary">Update BIN</button>
                        </div>
