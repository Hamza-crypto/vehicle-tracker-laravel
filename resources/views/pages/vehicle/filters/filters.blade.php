                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="location" id="location"
                                    ...
                                    @foreach($locations as $location)
                                        <option
                                            value="{{ $location }}" {{ request()->location == $location ? 'selected' : '' }}>{{ $location }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input id="date_paid" class="form-control daterange-filter" type="text" name="date_paid"
