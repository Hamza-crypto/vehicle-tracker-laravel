                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="filetype" id="filetype"
                                    ...
                                    <option value="copart_inventory" @if(request()->filetype == 'copart_inventory')
                                        selected @endif> Copart
                                        Inventory (Step 2)
                                    </option>
                                    <option value="copart_sale" @if(request()->filetype == 'copart_sale') selected
                                        @endif> Copart Sale
                                        (Step 3)
                                    </option>
                                </select>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="{{ $db_key }}" class="form-control form-select custom-select select2"
                                    data-toggle="select2">
                                    <option value="-100"> Select Field</option>
                                    @foreach($headers as $header)
                                    <option value="{{ $header }}" @if($header==$header_field) selected @endif>
                                        {{ $header }}</option>
                                    @endforeach
                                </select>
                            </td>
