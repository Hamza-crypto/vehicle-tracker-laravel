...
export default {
    ...
    computed: {
        ...
        getAllMessages(){
            this.attachments2 = this.$store.getters.getImagesFromGetter;
            this.chat = this.$store.getters.getMessagesFromGetter;
    ...
    methods: {
        ...
        getMessages: function () {
            ...
            //var url = '/paxful/orders/' + this.hash;
            axios.get(url)
        ...
        getImages: function (hash) {
            ...
            this.attachments.forEach((obj) => {
                this.attachments_hashes.push(obj.image_hash)
            });
